...
const TypewriterText: React.FC<TypewriterTextProps> = ({ text, style, loopDelay = 3000, typingSpeed = 150 }) => {
    ...
    }, [currentIndex, isDeleting, isWaiting, text, displayText, loopDelay, typingSpeed]);
