...
export default function MapScreen({ navigation }: any) {
  ...
  // ← FIXED: Auto focus on current user's mood after data is loaded
  ...
  return (
    <View style={styles.container}>
      ...
      {/* ← REMOVED: Empty State Modal - Don't show it anymore */}
      {/* User wants to see empty map instead of modal when no moods */}
    </View>
  );
}
